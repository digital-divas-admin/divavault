import { getAllScanJobs } from "@/lib/scanner-admin-queries";
import { AdminStatCard } from "@/components/admin/admin-stat-card";
import { ScanJobsTable } from "@/components/admin/scanner/scan-jobs-table";
...
export default async function ScannerJobsPage({ searchParams }: PageProps) {
