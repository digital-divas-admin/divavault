...
export function EarningsSummary() {
  return (
    <Card className="border-trust/20 bg-trust/5 rounded-2xl">
      <CardContent className="p-6 sm:p-8 text-center">
        <div className="rounded-full bg-trust/10 p-3 w-fit mx-auto mb-4">
          <DollarSign className="h-8 w-8 text-trust" />
        </div>
