  ...
  const levelContext = {
    strong: {
      foundSteps: [
        ...
        "Use Consented AI to file an automated DMCA takedown and track resolution.",
        "Consult a local attorney specializing in right of publicity claims for additional remedies.",
      ],
      protectSteps: [
        "Sign up for Consented AI to create your verified facial signature.",
      ...
      businessSteps: [
        ...
        "Sign up to learn how Consented AI can help verify and manage consent at scale.",
      ],
    },
    moderate: {
      foundSteps: [
        ...
        "Use Consented AI to file an automated DMCA takedown while your legal options are assessed.",
      ...
      businessSteps: [
        ...
        "Sign up to learn how Consented AI can help manage consent and compliance.",
      ],
    },
    basic: {
      foundSteps: [
        ...
        "Use Consented AI to file an automated DMCA takedown as a faster alternative to litigation.",
      ...
      protectSteps: [
        ...
        "Consented AI provides platform-level protections regardless of your state's laws.",
      ...
      businessSteps: [
        ...
        "Sign up to learn how Consented AI can help you manage consent proactively.",
      ],
    },
    none: {
      foundSteps: [
        ...
        "Use Consented AI to file an automated DMCA takedown — this works regardless of state law.",
      ...
      businessSteps: [
        ...
        "Sign up to learn how Consented AI can help future-proof your compliance.",
      ],
    },
  };
